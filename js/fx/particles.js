...
(function (RL) {
  ...
  var TYPES = {
    ...
    exhaust:   { life: [0.7, 1.2], size: [0.14, 0.2], grow: 6.0, drag: 2.2, gravity: -0.6, wind: 1, lit: 1, add: 0, emis: 0,
                 alpha: 0.3, color: [0.6, 0.6, 0.62], colorEnd: [0.8, 0.8, 0.82], spread: 0.5, fadeIn: 0.1, fadeOut: 0.6,
